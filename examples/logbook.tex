...
\CreateAuthor{Artur Palha}{apalha}{eScience Center}
\CreateContributor{hp}{Harry Potter}{hp}{Hoggwarts Institute of Technology}
\CreateContributor{jdoe}{Jane Doe}{jdoe}{Center for Advanced Studies in Awesome Research}
\CreateContributor{hs}{Hari Seldon}{hs}{Foundation Institute of Advanced Studies}

\SetProjectName{The very fancy project}

\begin{document}
\title{CinC-2016 Logbook}
\institutionlogo{figures/institution-logo.pdf}
...
%\chapter{The name of my chapter}
